...
const Menus = [
  { name: 'Forest', icon: { url: '/images/ic-forest.png', className: 'w-32 relative -bottom-1' } },
  { name: 'Task', icon: { url: '/images/ic-task.png', className: 'w-22 relative -bottom-line' } },
  { name: 'LB', icon: { url: '/images/ic-leaderboard.png', className: 'w-26 relative -bottom-2' } },
  { name: 'Lucky', icon: { url: '/images/ic-lucky.png', className: 'w-28 relative' } },
];
