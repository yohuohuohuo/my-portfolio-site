...
const RankItem: FC<RankItemInterface> = ({ item, type }) => {
  ...
  const itemConfig = useMemo(() => {
    ...
    switch (item.rankPlace) {
      case 1:
        return {
          rank: <CommonImg local src="/images/pic-gold.png" alt="Gold Medal" className="w-20" />,
          bg: {
      ...
      case 2:
        return {
          rank: <CommonImg local src="/images/pic-silver.png" alt="Silver Medal" className="w-20" />,
          bg: {
      ...
      case 3:
        return {
          rank: <CommonImg local src="/images/pic-bronze.png" alt="Bronze Medal" className="w-20" />,
          bg: {
  ...
  return (
    <div
      ...
      onClick={() => {
        item.greenId && item.greenId !== userInfo?.greenId && push(`/?id=${item.greenId}`);
      }}
      style={
        type !== 'mine'
          ? itemConfig.bg
