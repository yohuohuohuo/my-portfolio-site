...
const MenuConfig: { [key: string]: MenuItem } = {
  Task: {
    ...
    icon: <CommonImg local src="/images/ic-task.png" className="w-28 relative -bottom-2" alt={'icon'} />,
    name: 'Task',
  },
  Lucky: {
    background: 'linear-gradient(180deg, #FFC400 0%, #FFA900 121.25%)',
    icon: <CommonImg local src="/images/ic-lucky.png" className="w-32 relative -bottom-1" alt={'icon'} />,
    name: 'Lucky',
  },
  LB: {
    background: 'linear-gradient(180deg, #FFADB0 0%, #E3555A 100%)',
    icon: <CommonImg local src="/images/ic-leaderboard.png" className="w-30 relative -bottom-2" alt={'icon'} />,
    name: 'LB',
  },
  Invite: {
    ...
    icon: (
      <div className="relative">
        <CommonImg local src="/images/ic-invite.png" className="w-28 relative -bottom-0" alt={'icon'} />
        <div
  ...
  BP: {
    ...
    icon: <CommonImg local src="/images/ic-backpack.png" className="w-30 relative -bottom-2" alt={'icon'} />,
    name: 'BP',
  },
  MSG: {
    background: 'linear-gradient(180deg, #F9D06A 0%, #FF9000 88.75%)',
    icon: <CommonImg local src="/images/ic-msg.png" className="w-31 relative -bottom-2" alt={'icon'} />,
    name: 'News',
  },
  RP: {
    background: 'linear-gradient(180deg, #FFB261 0%, #FF006F 100%)',
    icon: <CommonImg local src="/images/ic-redpacket.png" className="w-32 relative -bottom-2" alt={'icon'} />,
    name: 'RP',
  },
};
